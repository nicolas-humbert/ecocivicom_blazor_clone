...
namespace ecocivicom_blazor_clone.Pages
{
    ...
    public partial class Index : ComponentBase
    {
        ...
        readonly List<AtelierFormationCard> AtelierFormationCards = new()
        {
            new AtelierFormationCard
            (
                new CasualLink("Nos formations en Prévention des Risques", "nos-formations"),
